...
- [Installation](#-installation)
  ...
  - [4. Configure environment variables](#4-configure-environment-varaibles)
    - [4.1 Defined .env variables](#41-defined-env-variables)
  - [5. Google Calendar API Setup](#5-google-calendar-api-setup)
    - [5.1 Enable Google Calendar API](#51-enable-google-calendar-api)
    - [5.2 Create OAuth Client Credentials](#52-create-oauth-client-credentials)
    - [5.3 Required JSON Structure](#53-required-json-structure)
    - [5.4 First-time authentication](#54-first-time-authentication)
- [Usage](#-usage)
- [License](#-license)
...
Check [Project Diagram](docs/ProjectDiagram.mmd) for full view on main flows (You may need to use [Mermaid](https://www.mermaidchart.com) for full diagram view).
